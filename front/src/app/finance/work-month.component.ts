...
export class FinanceWorkMonthComponent implements OnInit, OnDestroy {
    ...
    load() {
        this.loading = true;
        this.sub = this.service.showAllForYearByMonth(this.year).subscribe(data => {
            this.data = data.sort((a, b) => a.monthNumber - b.monthNumber);
